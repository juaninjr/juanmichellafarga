...
export interface ArtPiece {
  ...
  image: string;
  series?: string;
  /** Display order in the gallery — lower numbers appear first. Default: 999 */
  order?: number;
}
...
export const musicProjects: MusicProject[] = [
  {
   id: 'm8',
    ...
    coverImage: '/images/music/westcoast.png',
    spotifyUrl: 'https://open.spotify.com/album/07yiVpciG0Z9eooG2LYSw8?si=bbWZ6QzNSlKIuiGKDalAww',
  },
 {
    id: 'm9',
    artistName: 'emisito',
...
export const performances: Performance[] = [
  ...
  },
  {
    ...
    venue: '[Jesus College, Trinity Hall College, Robinson College, Queen\'s College, Razza Bar, Emmanuel College]',
    city: '[Cambridge]',
    date: '2026-02-20',
  ...
  },
  {
    ...
    venue: '[Jesus College, Downing College, Robinson College]',
    city: '[Cambridge]',
    date: '2026-02-20',
    role: 'Front Man for Fireflight Band',
    isFeatured: false,
...
export const artPieces: ArtPiece[] = [
  ...
  {
    id: 'a0',
    title: 'FIVE Media Clan',
    year: 2023,
    medium: 'painting',
    dimensions: '120 x 150 cm',
    description: 'Whole crew (took a year) - Acrylic',
    image: '/images/art/five.png',
    series: 'People',
  },
  {
    id: 'a1',
    title: 'Girl in Birmania',
    year: 2021,
    medium: 'painting',
    dimensions: 'A3',
    description: '',
    image: '/images/art/birmana.png',
    series: 'People',
  },
  {
    id: 'a2',
  ...
  },
  {
    ...
    description: 'Acrylic painting of a rocky cove.',
    image: '/images/art/bluerocks.png',
    series: 'Nature',
  },
  {
    id: 'a4',
    ...
    description: 'Abstract acrylic and cement representation of a morphed tree trunk',
    image: '/images/art/blue.png',
    series: 'Nature',
  },
  {
    id: 'a5',
    title: 'C-abras la boca tronco',
    year: 2022,
    medium: 'painting',
    dimensions: '50 x 60 cm',
    description: 'Acrylic painting of two goats in a rocky landscape.',
    image: '/images/art/cabras.png',
    series: 'Nature',
  },
  {
    id: 'a6',
  ...
  },
  {
    ...
    description: 'Watercolor pencils - pop image of Captain America.',
  ...
  },
  {
    ...
    medium: 'painting',
    dimensions: '60 x 50 cm',
    description: 'Acrylic, birmania road',
    image: '/images/art/corriendo.png',
    series: 'People',
  },
  {
    id: 'a11',
    ...
    medium: 'painting',
    dimensions: '60 x 50 cm',
    description: 'Acrylic, with some fog',
    image: '/images/art/fog.png',
    series: 'Nature',
  },
  {
    id: 'a12',
    ...
    medium: 'Ink',
    dimensions: '60 x 50 cm',
    description: 'Who is this? In ink.',
  ...
  },
  {
    ...
    description: 'A bull fight, swoosh but no moral assumptions please',
    image: '/images/art/toros.png',
    series: 'People',
  },
  {
    id: 'a19',
    ...
    description: 'Dont know who it is but it looks sick af',
    image: '/images/art/verde.png',
    series: 'Pop',
  },
  {
    id: 'a20',
    title: 'Light Guides The Way',
    year: 2018,
    medium: 'painting',
    dimensions: '70 x 80 cm',
    description: 'Acrylic - Light guides the way',
    image: '/images/art/yb.png',
    series: 'Nature',
  },
